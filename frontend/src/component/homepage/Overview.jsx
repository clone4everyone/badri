...
const Overview = () => {
  ...
  <div className="w-[90%] md:w-[75%] h-full z-10 backdrop-blur gap-3 flex flex-col md:flex-row items-center justify-center border-gray-400 border p-4">
    <div className="h-auto md:h-[70%] border-black border-r-0 md:border-r-2 px-3 flex flex-col items-center justify-center mb-4 md:mb-0 text-white md:text-black">
