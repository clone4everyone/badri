...
const BigImage = () => {
  ...
  >
    ...
    <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col items-start justify-center text-center text-white px-6 sm:px-8 md:pl-24">
      {/* Main Heading */}
      <h1 className="text-xl sm:text-4xl md:text-5xl lg:text-6xl text-start fira-sans leading-tight">
        Unique Housing & Land <br /> Solution for You
      </h1>
      {/* Subheading */}
      <p className="text-sm text-start sm:text-lg md:text-xl lg:text-2xl mt-4 mb-6 font-[Montserrat]">
