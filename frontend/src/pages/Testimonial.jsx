...
<div
      ...
      <div className="px-6 sm:pl-14 pt-10 text-center sm:text-left">
        ...
        <p className="text-2xl sm:text-3xl md:text-4xl font-bold [-webkit-text-stroke:1px_transparent] bg-[linear-gradient(180deg,rgb(0,0,0)_0%,rgb(102,102,102)_51.5%,rgb(0,0,0)_73.5%,rgb(102,102,102)_100%)] [-webkit-background-clip:text] [font-family:'Fira_Sans-Bold',Helvetica] mt-2 text-[#f5be86] leading-tight sm:leading-normal md:leading-[57.6px] whitespace-normal sm:whitespace-nowrap">
