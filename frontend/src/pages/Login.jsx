...
//   }, []);
  ...
  return (
    <>
      <Navbar/>
      <div className="flex h-screen items-center p-3  inset-0 bg-cover bg-center justify-center min-h-[90vh] grainy-dark" style={{backgroundImage:`url(${login})`}}>
        <Toast />
        <div className="w-full h-screen bg-black opacity-35 absolute">
