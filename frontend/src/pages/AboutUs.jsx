         ...
         <Navbar />
            ...
            <div className='w-full min-h-72 max-h-72 inset-0 bg-cover bg-center' style={{ backgroundImage: `url(${background})` }}>
                <div className='flex flex-col justify-end gap-3 h-72 pb-8 pl-14 text-white'>
                    ...
                    <p className='text-xl hover:cursor-pointer'><span className={()=>navigate('/')}>Home</span> {`>`} <span >About Us</span></p>
                </div>
            </div>

            <div className="p-12 min-h-72 pt-10 relative">
  <h1 className="text-2xl font-bold text-gray-800 mb-1 uppercase tracking-wide font-[Fira_Sans] text-center md:text-left">
    K SURESH BABU
  </h1>
  <p className="text-sm font-[Montserrat] text-center md:text-left">founder</p>
...
<div className="p-12  min-h-72 pt-10 relative bg-[#F0F1F2]">
  <div className="flex flex-col md:flex-row items-center rounded-lg overflow-hidden p-8 space-y-8 md:space-y-0 md:space-x-10">
    <div className="flex flex-col justify-center space-y-8 w-full md:w-2/3">
      <div className="flex-col">
        <h1 className="font-bold text-lg md:text-2xl font-[Fira_Sans] leading-snug text-gray-800">
          About <br /> SRI SAI RAM ESTATE <br /> & CONSTRUCTION
        </h1>
        <br />
        <div className="text-sm md:text-base font-[Montserrat] text-gray-600 leading-relaxed">
...
<div className="w-full relative  z-10 -top-72 md:-top-60 flex justify-center">
  <img
    src={cloud}
    className="w-[90%] md:w-[85%] max-w-4xl items-center"
  />
</div>
...
>
  ...
  <div className="text-center w-full text-black p-4 py-16 md:py-36 rounded-lg flex flex-col justify-center">
    <h1 className="text-lg md:text-xl font-bold mb-4 text-shadow font-[Fira_Sans]">
      Expanding horizons
    </h1>
    <p className="text-xs md:text-sm px-6 md:px-20 font-[Montserrat]">
      As the real estate landscape continued to change, so did we. Recognizing the evolving needs
      of our clients, we took the bold step of expanding our services. In response to increasing
      demand, we began to construct homes that not only met industry standards but also exceeded
      the expectations of our discerning customers. This expansion allowed us to offer a
      comprehensive range of services, from land acquisition to the construction of your dream home.
    </p>
  </div>
</div>
...
<div className="flex flex-col md:flex-row w-full">
  ...
  <div className="w-full md:w-1/2 h-64 md:h-full">
    <img
      src={comitment} // Replace with your image URL
      alt="Real Estate"
  ...
  <div className="w-full md:w-1/2 flex items-center justify-center bg-[#E9E9FB]">
    <div className="text-center px-6 py-8 md:px-16 md:py-12">
      <h2 className="text-lg md:text-xl font-bold text-gray-800 mb-4 md:mb-6 font-[Fira_Sans]">
        Our Commitment
      </h2>
      <p className="text-sm md:text-md text-gray-600 leading-relaxed font-[Montserrat]">
...
>
  <div className="text-center w-full text-black px-6 py-12 md:py-36 md:pt-10 rounded-lg flex flex-col justify-start">
    <h1 className="text-2xl md:text-4xl font-bold mb-4 text-shadow font-[Fira_Sans]">
      Our Vision
    </h1>
    <p className="text-sm md:text-md px-4 md:px-24 lg:px-48 font-[Montserrat]">
